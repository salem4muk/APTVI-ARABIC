...
import com.salem4muk.intentdemo.Common.Common;
import com.salem4muk.intentdemo.Config;
import com.salem4muk.intentdemo.R;
    ...
    public void onBackPressed() {

        {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                dialogBuilder = new AlertDialog.Builder(com.salem4muk.intentdemo.Player.ExoPlayerActivity.this);
            }
            else{
